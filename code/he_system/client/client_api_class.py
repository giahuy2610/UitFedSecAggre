...
class ClientApi():
    ...
    def launch_fl_session(self, NoClient: str):
        ...
        fl.client.start_numpy_client(server_address=self.fl_server_address, client=ClientHE(self.model_architecture  ,X_train, y_train, X_test, y_test, NoClient, self.clt_local_epochs))
